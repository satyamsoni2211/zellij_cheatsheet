  ...
  return (
    <div className="group relative bg-[var(--bg-secondary)] border border-[var(--border)] rounded-xl p-5 hover:border-[var(--border-strong)] transition-all duration-200">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="absolute top-4 right-4 p-1.5 rounded-lg bg-[var(--bg-primary)] border border-[var(--border)] opacity-0 group-hover:opacity-100 transition-all duration-200 hover:border-[var(--accent)] hover:bg-[var(--bg-secondary)]"
